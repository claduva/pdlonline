...
urlpatterns = [ 
    ...
    path("settings/leagues_moderating/<int:league_id>/configuration/<int:subleague_id>/season/manage_matches/create_schedule/", views.create_schedule, name="create_schedule"),
